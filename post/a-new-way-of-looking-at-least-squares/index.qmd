...
make_pairs(1:5)
```
Notice that `make_pairs()` is constructed such that *order doesn't matter*: we don't distinguish between $(4,5)$ and $(5,4)$, for example. This makes sense for our example: Alice and Bob denotes the same pair of students as Bob and Alice.
