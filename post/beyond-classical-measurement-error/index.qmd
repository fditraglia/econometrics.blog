...
Now that we've refreshed our memories about classical measurement error, let's take a look at my pop quiz question from above:
...
In other words, measurement error in a binary variable can never be classical.
