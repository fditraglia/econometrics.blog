...
To get a better idea of the impact of Covid19 in the UK, Dan Mead and I put together an R package [rcovidUK](https://github.com/fditraglia/rcovidUK) with weekly deaths in England and Wales, taken from the [Office for National Statistics](https://www.ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/deaths/datasets/weeklyprovisionalfiguresondeathsregisteredinenglandandwales) (ONS), allowing us to produce a plot of total deaths by region in 2020:
```{r}
#| label: plot
#| message: false
#| fig-height: 8
#| echo: false
#| fig-cap: Total Weekly Deaths in England & Wales.
library(tidyverse)
library(rcovidUK)
