...
As a teaser for our upcoming (2024-07-23) virtual reading group session on Bayesian macro / time series econometrics, this post replicates a classic paper by [Sims & Uhlig (1991)](https://ideas.repec.org/a/ecm/emetrp/v59y1991i6p1591-99.html) contrasting Bayesian and Frequentist inferences for a unit root. In the post I'll focus on explaining and implementing the authors' simulation design. In the reading group session (and possibly a future post) we'll talk more about the paper's implications for the Bayesian-Frequentist debate and relate it to more recent work by [Mueller & Norets (2016)](https://ideas.repec.org/a/taf/jnlasa/v111y2016i515p1233-1241.html). We'll also be joined by special guest [Frank Schorfheide](https://web.sas.upenn.edu/schorf/) who will help guide us through the recent literature on Bayesian approaches to VARs, including [Giannone et al (2015)](https://ideas.repec.org/a/tpr/restat/v97y2015i2p436-451.html) and [(2019)](https://ideas.repec.org/a/taf/jnlasa/v114y2019i526p565-580.html). If you're an Oxford student or staff member, you can sign up for the reading group [here](https://edstem.org/us/join/6j2hay). Otherwise, send me an email and I'll add you manually.
