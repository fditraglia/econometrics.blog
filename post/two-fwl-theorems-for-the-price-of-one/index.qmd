...
The result that I prefer to call [Yule's Rule](/post/how-to-do-regression-adjustment/#fnref2), more commonly known as the "Frisch-Waugh-Lovell (FWL) theorem", shows how to calculate the regression slope coefficient for **one predictor** by carrying out additional "auxiliary" regressions that adjust for **all other predictors**.
...
First we'll define the "Long Regression" as a [population linear regression](/post/why-econometrics-is-confusing-part-1-the-error-term/) of $Y$ on $X$ and $W$, namely 
$$
...
They are not assumptions; they are merely [what defines an error term](/post/why-econometrics-is-confusing-part-1-the-error-term/) in a population linear regression.
