---
title: Street Fighting Numerical Analysis - Part I
author: Francis J. DiTraglia
date: '2021-10-29'
subject: 'Computing & applied work'
series: 'Street Fighting Numerical Analysis'
series-label: 'Part I'
series-part-title: "Floating point, or why 0.2 × 20 isn't 4"
...
Computing is a crucial part of modern applied and theoretical econometrics but most economists, myself included, have little if any formal training in numerical analysis and computer science.
...
```
Since 0.2 multiplied by 20 equals 4, it comes as no surprise that replacing `times = 4` with `times = 0.2 * 20` gives the same result: 
```{r}
