...
I have a bowl containing 100 balls; $W$ of them are white and the rest are black. I remove 50 balls from the bowl and lay them on the table so you can see them all at once. Of these, 49 are white and 1 is black. What can you conclude about $W$? The answer depends crucially on *how I chose which balls to show you*. 
...
Suppose for simplicity that everyone who responds to the questionnaire does so truthfully. (We'll revisit this below.) 
