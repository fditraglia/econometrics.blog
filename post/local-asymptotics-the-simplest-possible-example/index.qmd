...
Sometimes this works out OK, and sometimes it's a [disaster](/post/don-t-use-the-textbook-ci-for-a-proportion/).
...
$$
and reject if $T_{n/2} > z_{1-\alpha}$.
